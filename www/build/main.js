...
var VerificationPage = /** @class */ (function () {
    ...
    VerificationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: "page-verification",template:/*ion-inline-start:"C:\source\philip\esocial_dev\src\pages\verification\verification.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>Verify Account</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <div *ngIf="user">\n\n    <div class="profile">\n\n      <img src="{{user.img}}" tappable (click)="setPhoto()" />\n\n    </div>\n\n    <!-- Show icon of logged in provider -->\n\n    <h4>\n\n      <span>{{user.name}} </span>\n\n      <ion-icon name="md-flame" *ngIf="user.provider == \'Firebase\'" class="firebase"></ion-icon>\n\n      <ion-icon name="logo-facebook" *ngIf="user.provider == \'Facebook\'" class="facebook"></ion-icon>\n\n      <ion-icon name="logo-google" *ngIf="user.provider == \'Google\'" class="google"></ion-icon>\n\n    </h4>\n\n    <div class="divider"></div>\n\n    <p>An email confirmation has been sent to: <span>{{user.email}}</span>.</p>\n\n    <!-- Verification Menu -->\n\n    <ion-list>\n\n      <ion-item no-lines tappable (click)="sendEmailVerification()">\n\n        Resend Confirmation Email\n\n        <ion-icon name="md-contact" item-right></ion-icon>\n\n      </ion-item>\n\n      <ion-item no-lines tappable (click)="setEmail()">\n\n        Change Email Address\n\n        <ion-icon name="md-mail-open" item-right></ion-icon>\n\n      </ion-item>\n\n      <ion-item no-lines tappable (click)="logout()">\n\n        Logout\n\n        <ion-icon name="md-log-out" item-right></ion-icon>\n\n      </ion-item>\n\n    </ion-list>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\source\philip\esocial_dev\src\pages\verification\verification.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
...
var ImageModalPage = /** @class */ (function () {
    ...
    ImageModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-image-modal',template:/*ion-inline-start:"C:\source\philip\esocial_dev\src\pages\image-modal\image-modal.html"*/'<ion-content>\n\n  <div class="content" (click)="close()" tappable>\n\n    <img src={{image}}/>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\source\philip\esocial_dev\src\pages\image-modal\image-modal.html"*/
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\source\philip\esocial_dev\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"C:\source\philip\esocial_dev\src\app\app.html"*/
        }),
